...
class _PersonalState extends State<Personal> {
  ...
  HashMap<int, List<String>> personalTasksHashMap = HashMap();
  ...
  Widget lowerContainer() {
    return Container(
        ...
        child: ListView.builder(
            itemCount: personalTasksHashMap.length,
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          personalTasksHashMap[index + 1]![0].toString(),
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          personalTasksHashMap[index + 1]![1].toString(),
                          style: const TextStyle(
                              color: Colors.white,
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "( ${personalTasksHashMap[index + 1]![2]} -- ${personalTasksHashMap[index + 1]![3]} )",
                          style: const TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.w300,
                              fontSize: 13),
